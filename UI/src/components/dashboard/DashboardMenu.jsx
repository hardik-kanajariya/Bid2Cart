...
function DashboardMenu() {
    ...
    return (<>
            <div className="col-lg-3">
                <div className="nav flex-column nav-pills gap-4 wow fadeInUp" data-wow-duration="1.5s"
                     data-wow-delay=".2s" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button className="nav-link active nav-btn-style mx-auto  mb-20" id="v-pills-dashboard-tab"
                    ...
                    <button className="nav-link nav-btn-style mx-auto mb-20" id="v-pills-profile-tab"
                            data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab"
                            aria-controls="v-pills-profile" aria-selected="true"><i className="lar la-user"/>
                        <svg width={22} height={22} viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <button className="nav-link nav-btn-style mx-auto" id="v-pills-purchase-tab" data-bs-toggle="pill"
                    ...
                    <button className="nav-link nav-btn-style mx-auto mb-20" id="v-pills-order-tab"
                    ...
                    <button className="nav-link nav-btn-style mx-auto mb-20" id="v-pills-pickup-tab"
                            data-bs-toggle="pill" data-bs-target="#v-pills-pickup" type="button" role="tab"
                            aria-controls="v-pills-pickup" aria-selected="true"><i
                        className='bx bx-archive-out mx-1'></i>
                        My Winnings
                    </button>
                    <button className="nav-link nav-btn-style mx-auto mb-20" id="v-pills-notification-tab"
                            data-bs-toggle="pill" data-bs-target="#v-pills-notification" type="button" role="tab"
                            aria-controls="v-pills-notification" aria-selected="true"><i
                        className='bx bx-notification mx-1'></i>
                        Notifications
                    </button>
                    <button onClick={userLogout} className="nav-link nav-btn-style mx-auto" type="button" role="tab">
                        <svg width={22} height={22} viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
