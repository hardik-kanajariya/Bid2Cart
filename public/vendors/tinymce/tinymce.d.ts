...
interface Schema {
    ...
    getCustomlements: () => SchemaMap;
    addValidElements: (validElements: string) => void;
    setValidElements: (validElements: string) => void;
    addCustomlements: (Customlements: string) => void;
...
interface CustomditorInit {
    setValue: (value: string) => void;
    getValue: () => string;
    destroy: () => void;
}
declare type CustomditorInitFn = (elm: HTMLElement, settings: any) => Promise<CustomditorInit>;
interface CustomditorOldSpec extends FormComponentSpec {
    type: 'Customditor';
    tag?: string;
    init: (e: HTMLElement) => Promise<CustomditorInit>;
}
interface CustomditorNewSpec extends FormComponentSpec {
    type: 'Customditor';
    tag?: string;
    scriptId: string;
    scriptUrl: string;
...
declare type CustomditorSpec = CustomditorOldSpec | CustomditorNewSpec;
...
declare type BodyComponentSpec = BarSpec | ButtonSpec | CheckboxSpec | TextAreaSpec | InputSpec | ListBoxSpec | SelectBoxSpec | SizeInputSpec | IframeSpec | HtmlPanelSpec | UrlInputSpec | DropZoneSpec | ColorInputSpec | GridSpec | ColorPickerSpec | ImageToolsSpec | AlertBannerSpec | CollectionSpec | LabelSpec | TableSpec | PanelSpec | CustomditorSpec;
interface BarSpec {
    type: 'bar';
    items: BodyComponentSpec[];
}
...
type PublicDialog_d_CustomditorSpec = CustomditorSpec;
type PublicDialog_d_CustomditorInit = CustomditorInit;
type PublicDialog_d_CustomditorInitFn = CustomditorInitFn;
