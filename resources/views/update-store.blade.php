                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" method="POST" enctype="multipart/form-data"
                                action="{{url('/')}}/auctions/stores/update/{{$store['id']}}">
                                @csrf
                                <div class="form-group row">
                                    <label for="" class="col-sm-3 col-form-label">Enter Store Name</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('title') is-invalid @enderror"
                                            value="{{$store['store_name']}}" name="name" value="{{ old('name') }}"
                                            required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('street') is-invalid @enderror" value="{{$store['street']}}" name="street">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="" class="col-sm-3 col-form-label">Enter City</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="city" class="form-control @error('city') is-invalid @enderror" value="{{$store['city']}}" value="{{ old('city') }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="state" class="form-control @error('state') is-invalid @enderror"
                                            value="{{$store['state']}}" value="{{ old('state') }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="" class="col-sm-3 col-form-label">Enter Pincode</label>
                                    <div class="col-sm-9">
                                        <input type="number" min="111111" max="999999" name="pincode" class="form-control @error('pincode') is-invalid @enderror" value="{{$store['pincode']}}" value="{{ old('pincode') }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="" class="col-sm-3 col-form-label">Enter Country</label>
                                    <div class="col-sm-9">
                                        <input type="text "name="country" class="form-control @error('country') is-invalid @enderror" value="{{$store['country']}}" required>
                                    </div>
                                </div>
